...
/**
 * check if a given file_name matches a list of regular expression taken from a template
 *
 * @param  {string} file name of the file to check if is ignored
 * @return {boolean} true | false
 */
function isFileIgnored (file_name) {
  // TODO this needs to be dynamically taken from the current template
  var regexList = ['.jar'];
  var matches = regexList.filter(regex => {
