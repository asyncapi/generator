...
| [options.debug] | <code>Boolean</code> | <code>false</code> | Enable more specific errors about filters. Keep in mind that as a result errors about template are less descriptive |
