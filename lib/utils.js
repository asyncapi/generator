...
const { migrateToOldAPI } = require('@asyncapi/parser/cjs');
...
utils.usesNewAPI = (templateConfig) => {
  return templateConfig.apiVersion === 'v2';
}

utils.getProperApiDocument = (asyncapiDocument, templateConfig) => {
  return utils.usesNewAPI(templateConfig) ? asyncapiDocument : migrateToOldAPI(asyncapiDocument);
}
