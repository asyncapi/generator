...
class Generator {
  ...
  verifyOptions(Options) {
    ...
    let invalidOptions = Object.keys(Options).filter(param => !GENERATOR_OPTIONS.includes(param)); 
    if (Options.registry) {
      invalidOptions = Object.keys(Options.registry).filter(param => !GENERATOR_OPTIONS.includes(param));
    }
