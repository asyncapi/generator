 ...
 * @return {Promise<TemplateRenderResult|Array<TemplateRenderResult>>}
 */
 ...
 * 
 * @private
 * @param {TemplateRenderResult|Array<TemplateRenderResult>} renderContent the react content rendered
...
reactExport.saveRenderedReactContent = async (renderContent, outputPath) => {
  ...
  const operations = renderContent.map(content => saveSingleFile(content, outputPath));
 ...
 * @param {String} outputpath Path to the file being rendered.
 */
async function saveSingleFile(renderContent, outputpath) {
