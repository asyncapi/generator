...
const {configureReact, renderReact} = require('./renderer/react');
...
class Generator {
  ...
  async renderFile(asyncapiDocument, filePath, extraTemplateData = {}) {
    ...
    return renderNunjucks(asyncapiDocument, tempalteString, filePath, extraTemplateData, this.templateParams, this.originalAsyncAPI, this.nunjucks);
  }
