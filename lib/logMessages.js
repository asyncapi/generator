...
function fileNotOverwritten(relativeSourceFile) {
  return `${relativeSourceFile} was not generated because it already exists and noOverwriteGlobs configuration in template configuration matched.`;
}
