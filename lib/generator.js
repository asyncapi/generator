    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (this.registry) {
        if (this.registry.url) {
          arbOptions.registry = this.registry.url;
        }
        if (this.registry.username) {
          arbOptions.username = this.registry.username;
        }
        if (this.registry.password) {
          arbOptions.password = this.registry.password;
        }
        if (this.registry.token) {
          arbOptions.token = this.registry.token;
        }
      }
