...
class Watcher {
  /**
   * Watch over given paths.
   * @param {*} paths to watch
   */
  constructor(paths) {
  ...
  /**
   * Returns wether or not this watcher object is watching for changes on defined paths.
   */
  isWatching() {
    let isWatching = false;
    for (const index in this.watchers) {
      if (this.watchers[index] !== null) {
        isWatching = true;
        break;
      }
    }
