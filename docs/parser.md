...
> To learn more about parser and access all of its features, you can check out the AsyncAPIs [Parser’s github repository](https://github.com/asyncapi/parser-js).
