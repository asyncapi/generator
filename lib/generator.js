...
class Generator {
  ...
  async validateTemplateConfig(asyncapiDocument) {
    ...
    if (typeof generator === 'string' && !semver.satisfies(packageJson.version, generator)) {
      throw new Error(`This template is not compatible with this version of the generator (${packageJson.version}). It's compatible with the following version range: ${generator}.`);
    }
