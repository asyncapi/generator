...
hljs.registerLanguage('cpp',(function() {'use strict'; return function(e) {const i=e.requireLanguage('c-like').rawDefinition(); return i.disableAutodetect=!1,i.name='C++',i.aliases=['cc','c++','h++','hpp','hh','hxx','cxx'],i;};}()));
...
hljs.registerLanguage('http',(function() {'use strict'; return function(e) {const n='HTTP/[0-9\\.]+'; return {name: 'HTTP',aliases: ['https'],illegal: '\\S',contains: [{begin: `^${n}`,end: '$',contains: [{className: 'number',begin: '\\b\\d{3}\\b'}]},{begin: `^[A-Z]+ (.*?) ${n}$`,returnBegin: !0,end: '$',contains: [{className: 'string',begin: ' ',end: ' ',excludeBegin: !0,excludeEnd: !0},{begin: n},{className: 'keyword',begin: '[A-Z]+'}]},{className: 'attribute',begin: '^\\w',end: ': ',excludeEnd: !0,illegal: '\\n|\\s|=',starts: {end: '$',relevance: 0}},{begin: '\\n\\n',starts: {subLanguage: [],endsWithParent: !0}}]};};}()));
hljs.registerLanguage('ini',(function() {'use strict'; function e(e) {return e?'string'===typeof e?e:e.source:null;} function n(...n) {return n.map(n => e(n)).join('');} return function(a) {const s={className: 'number',relevance: 0,variants: [{begin: /([\+\-]+)?[\d]+_[\d_]+/},{begin: a.NUMBER_RE}]},i=a.COMMENT(); i.variants=[{begin: /;/,end: /$/},{begin: /#/,end: /$/}]; const t={className: 'variable',variants: [{begin: /\$[\w\d"][\w\d_]*/},{begin: /\$\{(.*?)}/}]},r={className: 'literal',begin: /\bon|off|true|false|yes|no\b/},l={className: 'string',contains: [a.BACKSLASH_ESCAPE],variants: [{begin: '\'\'\'',end: '\'\'\'',relevance: 10},{begin: '"""',end: '"""',relevance: 10},{begin: '"',end: '"'},{begin: '\'',end: '\''}]},c={begin: /\[/,end: /\]/,contains: [i,r,t,l,s,'self'],relevance: 0},g=`(${[/[A-Za-z0-9_-]+/,/"(\\"|[^"])*"/,/'[^']*'/].map(n => e(n)).join('|')})`; return {name: 'TOML, also INI',aliases: ['toml'],case_insensitive: !0,illegal: /\S/,contains: [i,{className: 'section',begin: /\[+/,end: /\]+/},{begin: n(g,'(\\s*\\.\\s*',g,')*',n('(?=',/\s*=\s*[^#\s]/,')')),className: 'attr',starts: {end: /$/,contains: [i,c,r,t,l,s]}}]};};}()));
...
hljs.registerLanguage('json',(function() {'use strict'; return function(n) {const e={literal: 'true false null'},i=[n.C_LINE_COMMENT_MODE,n.C_BLOCK_COMMENT_MODE],t=[n.QUOTE_STRING_MODE,n.C_NUMBER_MODE],a={end: ',',endsWithParent: !0,excludeEnd: !0,contains: t,keywords: e},l={begin: '{',end: '}',contains: [{className: 'attr',begin: /"/,end: /"/,contains: [n.BACKSLASH_ESCAPE],illegal: '\\n'},n.inherit(a,{begin: /:/})].concat(i),illegal: '\\S'},s={begin: '\\[',end: '\\]',contains: [n.inherit(a)],illegal: '\\S'}; return t.push(l,s),i.forEach(((n) => {t.push(n);})),{name: 'JSON',contains: t,keywords: e,illegal: '\\S'};};}()));
...
hljs.registerLanguage('makefile',(function() {'use strict'; return function(e) {const i={className: 'variable',variants: [{begin: `\\$\\(${e.UNDERSCORE_IDENT_RE}\\)`,contains: [e.BACKSLASH_ESCAPE]},{begin: /\$[@%<?\^\+\*]/}]},n={className: 'string',begin: /"/,end: /"/,contains: [e.BACKSLASH_ESCAPE,i]},a={className: 'variable',begin: /\$\([\w-]+\s/,end: /\)/,keywords: {built_in: 'subst patsubst strip findstring filter filter-out sort word wordlist firstword lastword dir notdir suffix basename addsuffix addprefix join wildcard realpath abspath error warning shell origin flavor foreach if or and call eval file value'},contains: [i]},r={begin: `^${e.UNDERSCORE_IDENT_RE}\\s*(?=[:+?]?=)`},s={className: 'section',begin: /^[^\s]+:/,end: /$/,contains: [i]}; return {name: 'Makefile',aliases: ['mk','mak'],keywords: {$pattern: /[\w-]+/,keyword: 'define endef undefine ifdef ifndef ifeq ifneq else endif include -include sinclude override export unexport private vpath'},contains: [e.HASH_COMMENT_MODE,i,n,a,r,{className: 'meta',begin: /^\.PHONY:/,end: /$/,keywords: {$pattern: /[\.\w]+/,'meta-keyword': '.PHONY'}},s]};};}()));
hljs.registerLanguage('xml',(function() {'use strict'; return function(e) {const n={className: 'symbol',begin: '&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;'},a={begin: '\\s',contains: [{className: 'meta-keyword',begin: '#?[a-z_][a-z1-9_-]+',illegal: '\\n'}]},s=e.inherit(a,{begin: '\\(',end: '\\)'}),t=e.inherit(e.APOS_STRING_MODE,{className: 'meta-string'}),i=e.inherit(e.QUOTE_STRING_MODE,{className: 'meta-string'}),c={endsWithParent: !0,illegal: /</,relevance: 0,contains: [{className: 'attr',begin: '[A-Za-z0-9\\._:-]+',relevance: 0},{begin: /=\s*/,relevance: 0,contains: [{className: 'string',endsParent: !0,variants: [{begin: /"/,end: /"/,contains: [n]},{begin: /'/,end: /'/,contains: [n]},{begin: /[^\s"'=<>`]+/}]}]}]}; return {name: 'HTML, XML',aliases: ['html','xhtml','rss','atom','xjb','xsd','xsl','plist','wsf','svg'],case_insensitive: !0,contains: [{className: 'meta',begin: '<![a-z]',end: '>',relevance: 10,contains: [a,i,t,s,{begin: '\\[',end: '\\]',contains: [{className: 'meta',begin: '<![a-z]',end: '>',contains: [a,s,i,t]}]}]},e.COMMENT('\x3c!--','--\x3e',{relevance: 10}),{begin: '<\\!\\[CDATA\\[',end: '\\]\\]>',relevance: 10},n,{className: 'meta',begin: /<\?xml/,end: /\?>/,relevance: 10},{className: 'tag',begin: '<style(?=\\s|>)',end: '>',keywords: {name: 'style'},contains: [c],starts: {end: '</style>',returnEnd: !0,subLanguage: ['css','xml']}},{className: 'tag',begin: '<script(?=\\s|>)',end: '>',keywords: {name: 'script'},contains: [c],starts: {end: '<\/script>',returnEnd: !0,subLanguage: ['javascript','handlebars','xml']}},{className: 'tag',begin: '</?',end: '/?>',contains: [{className: 'name',begin: /[^\/><\s]+/,relevance: 0},c]}]};};}()));
