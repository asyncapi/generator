...
> 
⚠️ This feature is not recommended for production use, for those who want to try them out or learn more, see the [Baked-in template documentation](https://www.asyncapi.com/docs/tools/generator/baked-in-templates).
